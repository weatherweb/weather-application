                ...
                <div class="col-md-5">
                    <div class="contact-details">
                        ...
                        <div class="contact-info">
                            <address>
                                <img src="{{URL::asset('images/icon-marker.png')}}" alt="">
                                <p><a href="https://web.facebook.com/kashifali.khoso.7">Contact</a><br>
                                </p>
                            </address>

                            <a href="#"><img src="{{URL::asset('images/icon-phone.png')}}" alt="">+1 800 314 235</a>
                            <a href="#"><img src="{{URL::asset('images/icon-envelope.png')}}" alt="">contact@companyname.com</a>
                        </div>
                    </div>
                </div>
