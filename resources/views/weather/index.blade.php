...
@section('content')
    <div class="hero" data-bg-image="{{URL::asset('images/banner.png')}}">
        <div class="container">
        ...
        <div class="container">
            <div class="forecast-container">
                    ...
                    <div class="forecast-content">
                        ...
                        <div class="degree">
                            ...
                            <div class="forecast-icon">
                                <img src="{{URL::asset('images/icons/icon-1.svg')}}" alt="" width=90>
                            </div>
                        </div>
                        <span><img src="{{URL::asset('images/icon-umberella.png')}}" alt="">20%</span>
                        <span><img src="{{URL::asset('images/icon-wind.png')}}" alt="">18km/h</span>
                        <span><img src="{{URL::asset('images/icon-compass.png')}}" alt="">East</span>
                    </div>
                </div>
                <div class="forecast">
                    <div class="forecast-header">
                    ...
                    <div class="forecast-content">
                        <div class="forecast-icon">
                            <img src="{{URL::asset('images/icons/icon-3.svg')}}" alt="" width=48>
                        </div>
                ...
                <div class="forecast">
                    ...
                    <div class="forecast-content">
                        <div class="forecast-icon">
                            <img src="{{URL::asset('images/icons/icon-5.svg')}}" alt="" width=48>
                        </div>
                        <div class="degree">23<sup>o</sup>C</div>
                        <small>18<sup>o</sup></small>
                    </div>
                ...
                <div class="forecast">
                    ...
                    <div class="forecast-content">
                        <div class="forecast-icon">
                            <img src="{{URL::asset('images/icons/icon-7.svg')}}" alt="" width=48>
                        </div>
                        <div class="degree">23<sup>o</sup>C</div>
                        <small>18<sup>o</sup></small>
                    </div>
                ...
                <div class="forecast">
                    ...
                    <div class="forecast-content">
                        <div class="forecast-icon">
                            <img src="{{URL::asset('images/icons/icon-12.svg')}}" alt="" width=48>
                        </div>
                        <div class="degree">23<sup>o</sup>C</div>
                        <small>18<sup>o</sup></small>
                    </div>
                ...
                <div class="forecast">
                    ...
                    <div class="forecast-content">
                        <div class="forecast-icon">
                            <img src="{{URL::asset('images/icons/icon-13.svg')}}" alt="" width=48>
                        </div>
                        <div class="degree">23<sup>o</sup>C</div>
                        <small>18<sup>o</sup></small>
                    </div>
                ...
                <div class="forecast">
                    ...
                    <div class="forecast-content">
                        <div class="forecast-icon">
                            <img src="{{URL::asset('images/icons/icon-14.svg')}}" alt="" width=48>
                        </div>
                        <div class="degree">23<sup>o</sup>C</div>
                        <small>18<sup>o</sup></small>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="live-camera">
                            <figure class="live-camera-cover"><img src="{{URL::asset('images/live-camera-1.jpg')}}"
                                                                   alt=""></figure>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="live-camera">
                            <figure class="live-camera-cover"><img src="{{URL::asset('images/live-camera-2.jpg')}}"
                                                                   alt=""></figure>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="live-camera">
                            <figure class="live-camera-cover"><img src="{{URL::asset('images/live-camera-3.jpg')}}"
                                                                   alt=""></figure>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="live-camera">
                            <figure class="live-camera-cover"><img src="{{URL::asset('images/live-camera-4.jpg')}}"
                                                                   alt=""></figure>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="photo-grid">
                            <a href="#"><img src="{{URL::asset('images/thumb-1.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-2.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-3.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-4.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-5.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-6.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-7.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-8.jpg')}}" alt="#"></a>
                            <a href="#"><img src="{{URL::asset('images/thumb-9.jpg')}}" alt="#"></a>
                        </div>
                    </div>
                </div>
            </div>
